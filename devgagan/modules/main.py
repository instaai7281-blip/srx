...
async def is_normal_tg_link(link: str) -> bool:
    ...
    # Standard private links: t.me/c/12345/678
    # Topic links (exclude): t.me/c/12345/345/678
    special_identifiers = ['t.me/+', 't.me/c/', 't.me/b/', 'tg://openmessage']
    if 't.me/' not in link:
        return False
    
    # If it's a private link (contains t.me/c/), it's not "normal" for this logic
    if any(x in link for x in special_identifiers):
        return False
